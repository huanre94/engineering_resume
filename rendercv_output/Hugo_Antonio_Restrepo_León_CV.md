# Hugo Antonio Restrepo León's CV

- Phone: +593 99 136 3794
- Email: [huanre94@gmail.com](mailto:huanre94@gmail.com)
- Location: Guayaquil, Ecuador
- LinkedIn: [linkedin.com/in/hugo-restrepo-4ba05ba2](https://linkedin.com/in/linkedin.com/in/hugo-restrepo-4ba05ba2)
- GitHub: [github.com/huanre94](https://github.com/github.com/huanre94)


# Experience
## **Desarrollador Full Stack**, ILUM S.A. - Outsourcing: Cresa SA -- Guayaquil, Ecuador

Jun 2025 – presente

Desarrollo full stack con foco en servicios .NET, APIs REST, rendimiento e integración de componentes sobre SQL Server.
...
## **Desarrollador Full Stack**, Sipecom S.A. - Outsourcing: Mapfre Ecuador -- Guayaquil, Ecuador

Ago 2024 – May 2025

Desarrollo full stack para seguros con C#, APIs, SQL e integraciones orientadas a automatización y eficiencia operativa.
...
## **Desarrollador Full-Stack**, Viaxperta S.A. -- Guayaquil, Ecuador

Ago 2024 – Ago 2024

Mantenimiento y mejora de ERP interno con requerimientos funcionales y soporte al equipo de desarrollo.
...
## **Programador Apps Móviles**, Libélula Soft S.A. -- Guayaquil, Ecuador

Oct 2023 – Jul 2024

Desarrollo y mantenimiento de aplicaciones móviles bancarias, nuevas funcionalidades y liberaciones a tiendas.
...
## **Programador Senior Full Stack**, Nexti Solutions S.A. -- Guayaquil, Ecuador

Oct 2023 – Nov 2023

Diseño de servicios backend event-driven con C#, Azure Functions y mensajería para productos internos.
...
## **Analista Programador**, Saljuper S.A. -- Guayaquil, Ecuador

Nov 2020 – Sep 2023

Desarrollo full stack para retail con POS, ERP, APIs REST y SQL Server en entornos .NET.
...
## **Analista Programador**, Broadnet S.A. -- Guayaquil, Ecuador

Sep 2015 – Oct 2020

Desarrollo de software y apps Android para telecomunicaciones, facturación y optimización de procesos internos.
...
# Education
## **Universidad Católica de Santiago de Guayaquil**, Sistemas Computacionales -- Guayaquil, Ecuador

**Ingeniero**



## **Mundos E (Universidad Nacional de Córdoba)**, DevOps -- Córdoba, Argentina
...
# Skills
**Lenguajes de Programación:** C#, Java, TypeScript, JavaScript, Python, Visual Basic 6, Swift

**Frameworks y Tecnologías:** C#, .Net Framework, .Net Core, .Net 8, APIs REST, Angular, TypeScript, Entity Framework, Clean Architecture, SOLID

**Bases de Datos:** MS SQL Server, Oracle SQL, MongoDB, SQLite, Redis

**Herramientas y DevOps:** Git, GitHub, Docker, Azure Functions, RabbitMQ, Kafka, OpenTelemetry, Linux

**Arquitectura Backend:** Arquitectura por capas, microservicios, integraciones entre servicios, mensajería orientada a eventos, diseño de APIs REST

**Idiomas:** Español (nativo), Inglés (avanzado C2)
